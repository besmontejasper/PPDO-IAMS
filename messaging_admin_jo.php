...
<body>
  ...
  <nav class="w3-sidebar w3-bar-block w3-collapse w3-white w3-animate-left w3-card-2" style="z-index:3;width:320px;" id="mySidebar">
    ...
    <a href="javascript:void(0)" class="w3-bar-item w3-button w3-dark-grey w3-button w3-hover-indigo w3-left-align" onclick="document.getElementById('id02').style.display='block'" style="transition-duration: 0.3s;">Add Job Order<i class="w3-padding fa fa-plus"></i></a>
  </nav>
...
<div id="id02" class="w3-modal" style="z-index:4">
 <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px;">
  <header class="w3-container w3-yellow"> 
    ...
    class="w3-button w3-display-topright w3-xlarge w3-hover-red" style="transition-duration: 0.3s;"><i class="fa fa-remove"></i></span>
...
<div class="w3-container w3-border-top w3-padding-16 w3-light-grey">
 <a class="w3-button w3-hover-red" style="transition-duration: 0.3s;" onclick="document.getElementById('id02').style.display='none'">Cancel  <i class="fa fa-remove"></i></a>
