...
<?php
$retrieve_sent = mysqli_query($db, "SELECT * FROM messaging WHERE user_sender='$username' AND message_sent=1"); 
...
if ($sent_count!=0){
 ...
 <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">  
      <tr>
        <td style="color: green;">Subject</td>
        <td style="color: green;">Date and Time Sent</td>
      </tr>
      <tr>
      <?php 
      ...
      ?>
        ...
        <td><a href="messaging_sent.php?view=<?php echo $row['id']; ?>"><?php echo $row['message_subject']; ?></a></td>
        <td><a href="messaging_sent.php?view=<?php echo $row['id']; ?>"><?php echo $row['date_sent'] ?></a></td>
  ...
  <?php 
      ...
      $retrieve_sent = mysqli_query($db, "SELECT * FROM messaging WHERE user_sender='$username' AND message_sent=1  AND id='$message_id'");
      while ($row=mysqli_fetch_array($retrieve_sent)) {
    ?>
     <br>
    <br>
