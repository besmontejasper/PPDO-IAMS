...
<body class="w3-light-grey">
  ...
  <!--   <a href="staff.php" class="w3-bar-item w3-button w3-padding w3-hover-green"><i class="fa fa-users fa-fw"></i>  Staff</a>
    <a href="payroll.php" class="w3-bar-item w3-button w3-padding w3-hover-green"><i class="fa fa-money"></i>  Generate Payroll</a>
    <a href="records_payroll.php" class="w3-bar-item w3-button w3-padding w3-hover-green"><i class="fa fa-book fa-fw"></i>  Payroll Records</a> -->
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
    <h5><i class="fa fa-wrench fa-fw" style="color: #0f49ac;"></i> Repairs</h5>
    <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
      <?php 
      $db = mysqli_connect('localhost', 'root', '', 'sherwincatering');
      $results_rsrv = mysqli_query($db, "SELECT * FROM menu_reservation LIMIT 5"); 
      while ($row_rsrv = (mysqli_fetch_array($results_rsrv))) {
        ?>
        <tr>
          <td><?php echo $row_rsrv['rsrv_eventname'] ?></td>
          <td><?php echo $row_rsrv['rsrv_date'] ?></td>
        </tr>
        <?php } ?>
      </table><br>
      <a href="records_reservation.php"><button class="w3-button w3-black w3-hover-yellow" style="transition-duration: 0.3s;">More   <i class="fa fa-arrow-right"></i></button></a>
    </div>
