...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-white w3-animate-left w3-card-2" style="z-index:3;width:320px;" id="mySidebar">
  ...
  <a href="messaging_admin.php" class="w3-bar-item w3-button w3-hover-indigo"><i class="fa fa-inbox w3-margin-right"></i>Inbox<i class="fa fa-caret-down w3-margin-left"></i></a>
...
if ($trash_count!=0){
 ...
 <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">   
      ...
      ?>
        ...
        <td><a href="message_server_admin.php?restore=<?php echo $row['id']; ?>" class="restore_btn"><i class="fa fa-retweet w3-large w3-hover-text-blue"></i></a></td></td>
  ...
  <?php 
    ...
    <p class="w3-margin-left w3-border w3-padding-large w3-teal w3-margin-right"><?php echo $row['message_body']; ?></p>
     <a href="message_server_admin.php?restore=<?php echo $row['id']; ?>" class="restore_btn w3-bar-item w3-button w3-dark-grey w3-button w3-hover-indigo w3-margin-left w3-padding-large"  style="transition-duration: 0.3s; margin-top: 3%;"><i class="fa fa-retweet w3-large w3-hover-text-blue"></i>&nbsp;&nbsp;Restore</a>
