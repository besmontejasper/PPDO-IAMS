		...
		<div class="w3-main" style="margin-left:320px;">
			...
			if ($inbox_count!=0){
				...
				while ($row=mysqli_fetch_array($retrieve_sent)) {
					...
					<a href="javascript:void(0)" class="w3-bar-item w3-button w3-dark-grey w3-button w3-hover-blue w3-margin-left w3-padding-large" onclick="document.getElementById('id01').style.display='block'" style="transition-duration: 0.3s; margin-top: 3%;"><i class="fa fa-reply"></i>&nbsp;&nbsp;Reply</a>
					<?php
				}
			} 
		}
